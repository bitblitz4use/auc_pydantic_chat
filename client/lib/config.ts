...
export const apiUrl = {
  ...
  contextQuestionChallengeRun: (sessionId: string) =>
    `${API_CONFIG.CHAT_API}/api/compliance-graph/sessions/${encodeURIComponent(sessionId)}/context-challenge/question/run`,
